...
const Feed = () => {
    return (
        <div className="col-span-6 rounded-lg ">
            <div name="Storys" className="p-3 flex flex-row items-center">
                <div
                    name="Story"
            ...
            <div name="Posts" className="flex flex-col  bg-blue-50">
                <div className="grid grid-cols-12 gap-2 p-3 bg-red-500">
                        ...
                        <div
                            ...
                            <div className="flex flex-row items-center justify-between">
                                ...
                                <div className="ml-2">
                                    ...
                                    <p className="text-xs">08/02/2021 12:01</p>
                                </div>
                            </div>
                            <div className="mr-1">
                                <svg
